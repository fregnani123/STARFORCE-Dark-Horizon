...
            newProjectiles.push(new Projectile(this.x + this.width * 0.05 - 10, this.y, 20, 40,  "../assets/img/projectile/tiro.png", 600, 15, 'player', -DIAGONAL_ANGLE, false, null, false)); 
            newProjectiles.push(new Projectile(this.x + this.width * 0.95 - 10, this.y, 20, 40,  "../assets/img/projectile/tiro.png", 600, 15, 'player', DIAGONAL_ANGLE, false, null, false));
...
        if (!this.isAlive) return;
        ...
        // 🛑 CORREÇÃO 2: Teste de Fallback (Se a imagem não carregou/falhou)
        // Se a imagem não carregou ou não existe, desenha um quadrado vermelho como fallback
        if (!this.img || !this.img.complete) {
            ctx.save();
            ctx.fillStyle = 'red';
            // Usa as coordenadas X, Y do objeto para desenhar o quadrado
